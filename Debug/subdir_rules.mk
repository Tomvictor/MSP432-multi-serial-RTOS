...
build-1468014911:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1468014911-inproc

build-1468014911-inproc: ../empty.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-1468014911
configPkg/compiler.opt: build-1468014911
configPkg/: build-1468014911
